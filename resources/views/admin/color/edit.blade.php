                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('color.index') }}" class="btn btn-primary">Go Back to Color List</a>
                        </div>
                    </div>
                                ...
                                <form action="{{ route('color.update', $color->id) }}" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="name" name="name" class="form-control" value="{{ $color->name }}" placeholder="Enter name">
                                        </div>
