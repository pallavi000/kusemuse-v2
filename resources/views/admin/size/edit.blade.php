                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('size.index') }}" class="btn btn-primary">Go Back to Size List</a>
                        </div>
                    </div>
                                ...
                                <form action="{{ route('size.update', [$size->id]) }}" method="POST">
                                    ...
                                    @if ($errors->any())
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="name" name="name" class="form-control" value="{{ $size->name }}" placeholder="Enter name">
                                        </div>
